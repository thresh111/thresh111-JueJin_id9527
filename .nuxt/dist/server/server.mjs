import { getCurrentInstance, reactive, version, toRef, isRef, inject, nextTick, shallowRef, computed, isReadonly, defineComponent, ref, h, resolveComponent, provide, unref, Transition, Suspense, useSSRContext, mergeProps, withCtx, createVNode, defineAsyncComponent, onErrorCaptured, onServerPrefetch, createApp } from "vue";
...
const vueuse_head_plugin_Kdl6ItJXsn = defineNuxtPlugin((nuxtApp) => {
...
const _routes = [
  {
    name: (__nuxt_page_meta$1 == null ? void 0 : __nuxt_page_meta$1.name) ?? "article-id",
    path: (__nuxt_page_meta$1 == null ? void 0 : __nuxt_page_meta$1.path) ?? "/article/:id",
    children: [],
    meta: __nuxt_page_meta$1,
    alias: (__nuxt_page_meta$1 == null ? void 0 : __nuxt_page_meta$1.alias) || [],
    redirect: (__nuxt_page_meta$1 == null ? void 0 : __nuxt_page_meta$1.redirect) || void 0,
    component: () => import("./_nuxt/_id_-e8bafc86.js").then((m) => m.default || m)
  },
  {
    ...
    component: () => import("./_nuxt/index-47125926.js").then((m) => m.default || m)
  }
];
...
const router_zquOLLvpqf = defineNuxtPlugin(async (nuxtApp) => {
  var _a, _b;
  let __temp, __restore;
...
const plugin_server_ZTo2hTGmhC = defineNuxtPlugin((nuxtApp) => {
...
const vue_dompurify_html_ER8SW1XOdk = defineNuxtPlugin((nuxtApp) => {
  nuxtApp.vueApp.use(VueDOMPurifyHTML);
});
const _plugins = [
  components_plugin_KR1HBZs4kY,
  vueuse_head_plugin_Kdl6ItJXsn,
  router_zquOLLvpqf,
  plugin_server_ZTo2hTGmhC,
...
const layouts = {
  default: () => import("./_nuxt/default-bcc130fa.js").then((m) => m.default || m)
};
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = defineAsyncComponent(() => import("./_nuxt/error-component-4f2611fe.js").then((r) => r.default || r));
    const IslandRendererer = defineAsyncComponent(() => import("./_nuxt/island-renderer-0a02eb98.js").then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/registry.npmmirror.com+nuxt@3.2.0_h5nqvx6zt657irmnd4ouaingse/node_modules/nuxt/dist/app/components/nuxt-root.vue");
...
export {
  ...
  entry$1 as default,
  debugWarn as e,
  useGlobalConfig as f,
  useNuxtApp as g,
  defaultNamespace as h,
  useIdInjection as i,
  useId as j,
  useState as k,
  useHead as l,
